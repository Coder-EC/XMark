...
//        if (e.getSource() instanceof TitleBar) {
//            draggingAnchor = new Point(
//                    e.getX() + ((TitleBar) e.getSource()).getX(),
//                    e.getY() + ((TitleBar) e.getSource()).getY());
//            top = false;
//            down = false;
//            left = false;
//            right = false;
...
//            if (e.getSource() instanceof TitleBar) {
//                Frame.getFrames()[0].setLocation(e.getLocationOnScreen().x - draggingAnchor.x, e.getLocationOnScreen().y - draggingAnchor.y);
//            } else {
